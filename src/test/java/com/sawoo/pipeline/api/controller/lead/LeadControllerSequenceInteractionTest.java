...
class LeadControllerSequenceInteractionTest extends BaseLightControllerTest<LeadDTO, Lead, LeadService, LeadMockFactory> {
    ...
    @Autowired
    public LeadControllerSequenceInteractionTest(LeadMockFactory mockFactory, LeadService service) {
        super(mockFactory,
    ...
    @Test
    @DisplayName("GET /api/leads/{id}/sequences/{sequenceId}/interactions/eval: evaluate interaction to be created based on a sequence and a lead - Success")
    ...
    @Test
    @DisplayName("GET /api/leads/{id}/sequences/{sequenceId}/interactions/eval: lead not found - Failure")
    ...
    private List<InteractionAssigneeDTO> getInteractions(int interactionSize) {
