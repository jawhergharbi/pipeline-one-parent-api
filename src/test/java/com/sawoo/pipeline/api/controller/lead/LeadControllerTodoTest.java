...
class LeadControllerTodoTest extends BaseLightControllerTest<LeadDTO, Lead, LeadService, LeadMockFactory> {
    ...
    @Test
    @DisplayName("POST /api/leads/{id}/todos: lead id and interaction valid - Success")
    void addInteractionWhenLeadIdAndInteractionValidReturnsSuccess() throws Exception {
        ...
        TodoDTO postInteraction = getMockFactory().getTodoMockFactory().newDTO(null);
        TodoDTO createdInteraction = getMockFactory().getTodoMockFactory().newDTO(INTERACTION_ID, postInteraction);

        // setup the mocked service
        doReturn(createdInteraction).when(service).addInteraction(anyString(), any(TodoDTO.class));
        ...
        mockMvc.perform(post(getResourceURI() + "/{id}/interactions", LEAD_ID)
                ...
                .andExpect(header().string(HttpHeaders.LOCATION, getResourceURI() + "/" + LEAD_ID + "/todos/" + INTERACTION_ID))
    ...
    @Test
    @DisplayName("POST /api/leads/{id}/todos: lead id null and interaction valid - Success")
    ...
    @Test
    @DisplayName("POST /api/leads/{id}/todos: lead not found and interaction valid - Success")
    void addInteractionWhenLeadNotFoundAndInteractionValidReturnsFailure() throws Exception {
        ...
        // setup the mocked service
        doThrow(exception).when(service).addInteraction(anyString(), any(TodoDTO.class));
    ...
    @Test
    @DisplayName("DELETE /api/leads/{id}/todos/{interactionId}: lead and interaction found - Success")
    void removeInteractionWhenLeadFoundAndInteractionFoundReturnsSuccess() throws Exception {
        // Set up mocks
        String LEAD_ID = getMockFactory().getComponentId();
        String INTERACTION_ID = getMockFactory().getTodoMockFactory().getComponentId();
        TodoDTO interactionToBeDeleted =
                getMockFactory().getTodoMockFactory().newDTO(INTERACTION_ID);
    ...
    @Test
    @DisplayName("DELETE /api/leads/{id}/todos/{interactionId}: lead not found and interaction found - Success")
    ...
    void removeInteractionWhenInteractionNotFoundReturnsFailure() throws Exception {
        ...
        ResourceNotFoundException exception = new ResourceNotFoundException(
                ExceptionMessageConstants.COMMON_GET_COMPONENT_RESOURCE_NOT_FOUND_EXCEPTION,
                new String[]{ DBConstants.TODO_DOCUMENT, String.valueOf(INTERACTION_ID) });
    ...
    @Test
    @DisplayName("GET /api/leads/{id}/todos: lead found and interaction list - Success")
    void getInteractionsWhenLeadFoundAndInteractionListFoundReturnsSuccess() throws Exception {
        ...
        List<TodoAssigneeDTO> interactionList = IntStream
    ...
    @Test
    @DisplayName("GET /api/leads/{id}/todos: lead found and interaction list is empty- Success")
    ...
    @Test
    @DisplayName("GET /api/leads/{id}/todos/{interactionId}: lead and interaction found - Success")
    void getInteractionWhenLeadFoundAndInteractionFoundReturnsSuccess() throws Exception {
        // Set up mocks
        String LEAD_ID = getMockFactory().getComponentId();
        String INTERACTION_ID = getMockFactory().getTodoMockFactory().getComponentId();
        TodoAssigneeDTO interactionMock = getMockFactory()
