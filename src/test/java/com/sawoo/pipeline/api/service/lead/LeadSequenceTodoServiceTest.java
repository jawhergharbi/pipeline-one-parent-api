...
class LeadSequenceTodoServiceTest extends BaseLightServiceTest<LeadDTO, Lead, LeadRepository, LeadService, LeadMockFactory> {
    ...
    @Autowired
    public LeadSequenceTodoServiceTest(LeadMockFactory mockFactory, LeadService service) {
