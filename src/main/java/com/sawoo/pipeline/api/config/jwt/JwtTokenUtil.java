...
public class JwtTokenUtil {
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser().setSigningKey(getEncodedSecret(secret)).parseClaimsJws(token).getBody();
    }
    ...
    public String generateToken(UserDetails userDetails, String id) {
        ...
        claims.put(CommonConstants.USER_ID_KEY, id);
        claims.put(CommonConstants.AUTHORITIES_KEY, userDetails.getAuthorities());
