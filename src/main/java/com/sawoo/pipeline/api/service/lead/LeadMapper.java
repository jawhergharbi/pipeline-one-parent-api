...
public class LeadMapper implements BaseMapper<LeadDTO, Lead> {
    ...
    private final JMapper<LeadInteractionDTO, LeadInteraction> interactionMapperOut = new JMapper<>(LeadInteractionDTO.class, LeadInteraction.class);
    private final JMapper<LeadInteraction, LeadInteractionDTO> interactionMapperIn = new JMapper<>(LeadInteraction.class, LeadInteractionDTO.class);
}
